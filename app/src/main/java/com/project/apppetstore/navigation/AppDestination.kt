...
sealed class AppDestination(
    ...
    data object Checkout : AppDestination("checkout/{productId}/{quantity}", R.string.nav_products) {
    ...
    data object Favorites     : AppDestination("favorites",     R.string.nav_profile, iconRes = R.drawable.ic_heart)
    data object Orders        : AppDestination("orders",        R.string.nav_profile, iconRes = R.drawable.ic_shopping_bag)
